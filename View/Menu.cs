...
namespace CalculatorScope
{
    public partial class Menu : Form
    {
        ...
        private void numero13ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void numero14ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenExercises<Ejercicio14>();
        }

        private void numero15ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenExercises<Ejercicio15>();
        }

        private void numero16ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenExercises<Ejercicio16>();
        }
    }
}
